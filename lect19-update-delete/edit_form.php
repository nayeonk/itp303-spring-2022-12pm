...
// Check to make sure we received a track_id at this point
...
<select name="genre" id="genre-id" class="form-control">
	...
	<!-- Run through ALL genres. If the genre id matches this track's genre id, add a SELECTED attribute to that option tag-->
