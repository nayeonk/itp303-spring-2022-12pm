<?php
// require imports in config.php that stores our credentials as constants
require "config/config.php";
// the only difference between require and include is that if a file is "required" but does not exist, it will throw a fatal error
